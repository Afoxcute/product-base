  ...
  const data = [
    {
      ...
      topic: "Our Expertise",
      content:
        "With years of experience in the recycling industry, our team at Basearpsagrictrack possesses a deep understanding of waste management practices, recycling techniques, and market dynamics. We leverage this expertise to develop solutions that streamline recycling processes, improve efficiency, and maximize the impact of recycling efforts.",
    },
    {
      vector: lightSVG,
      topic: "I.R.A",
      content:
        "(Innovative Recycling Approach) We take a fresh approach to recycling by integrating technology and cryptocurrency into the traditional recycling ecosystem. Our platform provides users with a seamless and convenient way to recycle various materials, transforming it into a rewarding experience. Through our user-friendly mobile application, individuals can track their recycling progress, earn Basearpsagrictrack tokens, and contribute to a sustainable future.",
    },
    {
      vector: recycleSVG,
      topic: (
    ...
    },
    {
      ...
      content:
        "At Basearpsagrictrack, we believe in recognizing and incentivizing individuals for their recycling efforts. Every time you recycle, you earn Basearpsagrictrack tokens, our exclusive cryptocurrency. These tokens can be redeemed for various rewards, including discounts at partner stores, exclusive merchandise, and even charitable donations. By aligning economic benefits with environmental action, we motivate individuals to embrace recycling as a rewarding habit.",
    },
    {
      vector: HandSVG,
      topic: (
